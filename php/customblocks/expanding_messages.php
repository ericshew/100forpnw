...
if ( is_admin() ) {
    ...
    echo '<strong>anchor:  </strong>' . $anchor;
    ...
    echo '<div class = "block expandingMessages notReady" data-blockID = "' . $blockID . '" id = "' . $anchor.  '">';
                ...
                if ( have_rows('messages') ) {
                    ...
                    echo '<div class = "text">';   
                        echo '<div class = "headlines">';   
                            // echo '<h3 id = "tf1" class = "subhead1"><span>' . $subhead1 . '</span></h3>';
                            // echo '<h3 id = "tf2" class = "subhead2"><span>' . $subhead2 . '</span></h3>';
                            echo '<h3 id = "tf1" class = "subhead1"><span></span></h3>';
                            echo '<h3 id = "tf2" class = "subhead2"><span>  </span></h3>';
                        echo '</div>';
                        echo '<div class = "body wrapper">';  
                            // echo '<div class= "body element">' . $body . '</div>';
                            echo '<div class= "body element"><p></div>';
                            echo '<div class = "overflowButton"></div>';
                            
                            // echo '<a class = "button" target="_blank" href =" ' . $url . '">' . $overflowPageText . '</a>';
                        echo '</div>';
                    echo '</div>';
                 }
            echo '</div>';
